...
Here you will find a sample application for TASS PVL, a Computer Vision security system using Intel® Computer Vision SDK and an Intel® Edison connected to the Internet of Things via IoT JumpWay.
...
1. [IoT JumpWay Node JS MQTT Client Library](https://github.com/iotJumpway/IoT-JumpWay-NodeJS-MQTT-Client "IoT JumpWay Node JS MQTT Client Library")

2. [IoT JumpWay WebSocket MQTT Client](https://github.com/iotJumpway/IoT-JumpWay-WebSockets-MQTT-Client "IoT JumpWay WebSocket MQTT Client")

3. [Intel® Computer Vision SDK for Windows 10](https://github.com/iotJumpway/IoT-JumpWay-Intel-Examples/blob/master/Intel-Computer-Vision-SDK/TASS-PVL/Windows/_Docs/1-Installing-Intel-CV-SDK.md "Intel® Computer Vision SDK for Windows 10")
